...
*/
public class AuditOscarResponse extends GenericRESTResponse implements Serializable {

    private static final long serialVersionUID = 1L;

    private AuditOscarTo1 audit;

    public AuditOscarTo1 getAudit() {
        return this.audit;
    }

    public void setAudit(AuditOscarTo1 audit) {
        this.audit = audit;
    }
}
