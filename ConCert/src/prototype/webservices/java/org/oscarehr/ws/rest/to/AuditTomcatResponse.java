...
*/
public class AuditTomcatResponse extends GenericRESTResponse implements Serializable {

    private static final long serialVersionUID = 1L;

    private AuditTomcatTo1 audit;

    public AuditTomcatTo1 getAudit() {
        return this.audit;
    }

    public void setAudit(AuditTomcatTo1 audit) {
        this.audit = audit;
    }
}
