...
*/
public class AuditDatabaseResponse extends GenericRESTResponse implements Serializable {

    private static final long serialVersionUID = 1L;

    private AuditDatabaseTo1 audit;

    public AuditDatabaseTo1 getAudit() {
        return this.audit;
    }

    public void setAudit(AuditDatabaseTo1 audit) {
        this.audit = audit;
    }
}
