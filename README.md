...
### Design Decisions
1. Why utilize a **Stack** when grabbing and sorting files? *(Audit.java)*<br>
...
2. Why are all methods **private** and **static?** *(Audit.java)*<br>
...
3. How are you checking for Tomcat reinforcement? *(Audit.java)*<br>
...
4. Why use JSTL tags with JavaServer pages? *(Test.jsp)*<br>
